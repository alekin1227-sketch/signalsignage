...
export function UsersPage(){
  ...
  return <>
    <div className="page-heading"><div><span className="eyebrow">Controle administrativo</span><h1>Usuários do Painel</h1><p>Gerencie pessoas, funções e permissões de acesso à central SOMAI.</p></div><div className="live-indicator"><i/><span>{users.length} usuários cadastrados</span></div></div>
