...
export function PlayerAccessPage(){
  ...
  return <>
    <div className="mb-7"><h1 className="text-3xl font-bold">Acessos do Player</h1><p className="text-slate-500">Crie usuários usados somente para ativar Mini PCs e TVs.</p></div>
